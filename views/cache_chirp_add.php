  ...
  <div class="col-lg-12">
    ...
    <form action="/chirp/add" method="post">
      <div class="form-group">
        ...
        <textarea class="form-control" id="chirp_content" name="chirp_content" placeholder="Enter content" rows="12"><?php echo(htmlentities($chirp['chirp_content'])); ?></textarea>
      </div>
      <div class="form-group">
      ...
      <input type="hidden" id="datestamp" name="datestamp" value="<?php echo(htmlentities($chirp['datestamp'])); ?>" />
    </form>
  </div>
</div>
