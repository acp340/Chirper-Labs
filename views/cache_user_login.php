  ...
  <div class="col-lg-12">
    ...
    <form action="/user/login" method="post">
      <div class="form-group">
        ...
        <input type="text" min="1" id="email" name="form[email]" class="form-control" placeholder="Enter email address or username" value="<?php echo(htmlentities(value($form['email']))); ?>" />
      </div>
      <div class="form-group">
